        ...
        <div className="mx-auto max-w-screen-xl  space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="anoucement grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-3 ">
            ...
            <div className="btn_container flex items-center sm:justify-end justify-center">
              <button
                className="group relative inline-flex items-center overflow-hidden rounded bg-white font-heading  px-8 py-3 text-brand-blue focus:outline-none"
                onClick={() => navigate("/create_post")}
              >
                <span className="absolute -end-full transition-all group-hover:end-4 text-brand-blue">
                  <svg
                ...
                <span className="text-sm font-medium transition-all text-brand-blue group-hover:me-4">
                  {"Let's Sell Now!"}
                </span>
              </button>
            </div>
          ...
          <div className="anoucement grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-3 ">
            ...
            <div className="btn_container flex items-center sm:justify-end justify-center">
              ...
              >
                ...
                <span className="text-sm font-medium transition-all  group-hover:me-4 text-brand-blue">
                  {"Let's Take Rent!"}
                </span>
              </button>
            </div>
