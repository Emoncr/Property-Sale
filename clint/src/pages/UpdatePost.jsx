                            ...
                            <div className='feilds_container grid gap-5 md:gap-10  grid-col-1 md:grid-cols-2 items-start  '>
                                ...
                                ">
                                                    ...
                                                    <input
                                                        ...
                                                        className="radio w-5 h-5 checked:bg-brand-blue"
                                                        {...register('type')}
                                                        checked={formData.type === 'sale'} // Check if formData.type matches 'sale'
                                                    />
                                ...
                                ">
                                                    ...
                                                    <input
                                                        ...
                                                        className="radio w-5 h-5 checked:bg-brand-blue"
                                                        {...register('type')}
                                                        checked={formData.type === 'rent'} // Check if formData.type matches 'rent'
                                                    />
                                            ...
                                            <div className="form-control">
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        ...
                                                        checked={formData.parking ? true : false}
                                                    />
                                                ...
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        ...
                                                        checked={loadData && loadData.furnished}
                                                    />
