      ...
      <div className="container !max-w-7xl mx-auto grid md:gap-8 temp lg:grid-cols-4  md:grid-cols-5 grid-cols-1 ">
        <div className="profile_info p-5 bg-white border-[1px] w-full rounded-md shadow-brand md:col-span-2 lg:col-span-1 col-span-1 ">
          <form className='w-full'>
            <div className='mb-3'>
              <div className="image_containe w-full flex items-center justify-center  relative max-w-[100px] mx-auto">
                ...
                <img src={currentUser.avatar} onClick={() => fileRef.current.click()} className='h-24 w-24 mb-3 rounded-full border-[1px]  border-brand-blue' alt="profile image" />
            ...
            <input defaultValue={currentUser.username} {...register("username", { required: true })} type="text" placeholder="Username" className="form_input bg-slate-200 rounded-md !pl-3 mt-1 !border-[1px] focus:!border-brand-blue mb-3" />


            <label className='text-left font-heading text-sm pl-1 '>Email</label>
            <input defaultValue={currentUser.email} {...register("email", { required: true })} type="email" placeholder="Username" className="  form_input bg-slate-200 rounded-md !pl-3 !border-[1px] focus:!border-brand-blue mb-3" />


            <label className='text-left font-heading text-sm pl-1 '>Password</label>
            <input  {...register("password", { required: true })} type="password" placeholder="Password" className="mt-1  form_input bg-slate-200 rounded-md !pl-3 !border-[1px] focus:!border-brand-blue" />
          ...
          <div className="btns-container flex justify-between items-center md:flex-col xl:flex-row">
